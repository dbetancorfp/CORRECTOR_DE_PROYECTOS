...
// schema.sql seeds one throwaway admin (id=1, password '12345678') on every fresh
// apply — replaced below by the full fixture, which reassigns id=1 to 'admin'
// with the credentials tests/auth.test.ts actually logs in with.
