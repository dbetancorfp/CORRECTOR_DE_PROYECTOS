...
export const InteractionSchema = z.object({
  ...
  response: z.string(),
  target_elements: z.array(z.number().int().positive()).optional(),
});
...
export const ComponentSchema = z.object({
  sketchNumber: z.number().int().positive(),
  type: ComponentType,
...
export const ScreenSchema = z.object({
  ...
  sketch_numbers: z.array(z.number().int().positive()),
...
export const UISpecSchema = z.object({
  ...
  agent: z.literal('designer-front'),
  model: z.string(),
